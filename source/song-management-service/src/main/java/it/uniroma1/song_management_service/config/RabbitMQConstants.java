...
public class RabbitMQConstants {
    ...
    public static final String INDEX_EXCHANGE = "index.exchange";
    ...
    public static final String SONG_INDEX_ROUTING_KEY = "song.index";
    public static final String SONG_INDEX_QUEUE = "song.index.uploads";
